    ...
    <body>
        ...
        <main>
            <section class="main">
                ...
                <div>
                    <div class="title" id="dark-black">Chapter 2 - First Yuan Heavy Water</div>
                    <div id="black">
                        ...
                        <div class="title" id="dark-black"><a href="ongoing-books-list/demon-god-trafford/chapter1.php">Previous Chapter</a></div>
                        <div class="title" id="dark-black"><a href="ongoing-books-list/demon-god-trafford/chapter3.php">Next Chapter</a></div>
                    </div>
