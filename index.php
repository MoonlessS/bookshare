<?php
    include_once("bookshare/common/database.php");

    include_once("bookshare/apresentacao/header.php");
    include_once("bookshare/apresentacao/footer.php");
    include_once("bookshare/apresentacao/nav.php");
    include_once("bookshare/apresentacao/banner.php");
?>
